...
void VideoPlayerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->OnAvailableSubtitlesChanged(); break;
        case 2: _t->OnAvailableAudioChannelsChanged(); break;
        case 3: _t->OnCustomContextMenuRequested((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 4: _t->OnSubtitleChosen((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->OnAudioChannelChosen((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->updateWindowActiveState(); break;
        default: ;
        }
    }
}
