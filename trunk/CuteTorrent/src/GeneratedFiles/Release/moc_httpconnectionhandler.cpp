...
static const char qt_meta_stringdata_HttpConnectionHandler[] = {
    "HttpConnectionHandler\0\0socketDescriptor\0"
    "handleConnection(int)\0readTimeout()\0"
    "read()\0disconnected()\0"
};
...
void HttpConnectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handleConnection((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObjectExtraData HttpConnectionHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject HttpConnectionHandler::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_HttpConnectionHandler,
      qt_meta_data_HttpConnectionHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &HttpConnectionHandler::getStaticMetaObject() { return staticMetaObject; }
