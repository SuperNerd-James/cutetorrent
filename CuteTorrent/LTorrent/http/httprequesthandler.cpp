...
{
	QApplicationSettings* settings=QApplicationSettings::getInstance();
	requireAuth = settings->valueBool("WebControl","requireAuth",false);
	
	account.username = settings->valueString("WebControl","webui_login","admin");
	account.password = settings->valueString("WebControl","webui_password","admin");
