...
void QTorrentDisplayModel::qt_static_metacall(QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if(_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch(_id)
        {
            ...
            case 1:
                _t->updateTabSender((*reinterpret_cast< int (*) > (_a[1])));
                break;

            case 2:
                _t->onTorrentRemove((*reinterpret_cast< QString(*) > (_a[1])));
                break;

            case 3:
                _t->UpdateSelectedIndex((*reinterpret_cast< const QItemSelection(*) > (_a[1])));
                break;

            case 4:
                _t->contextualMenu((*reinterpret_cast< const QPoint(*) > (_a[1])));
                break;
            ...
            case 16:
                _t->initSessionFinished();
                break;

            case 17:
                _t->generateMagnetLink();
                break;
...
const QMetaObject& QTorrentDisplayModel::getStaticMetaObject()
{
