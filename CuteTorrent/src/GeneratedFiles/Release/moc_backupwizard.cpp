...
static const char qt_meta_stringdata_BackupWizard[] = {
    "BackupWizard\0"
};
...
const QMetaObjectExtraData BackupWizard::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BackupWizard::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_BackupWizard,
      qt_meta_data_BackupWizard, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BackupWizard::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BackupWizard))
        return static_cast<void*>(const_cast< BackupWizard*>(this));
